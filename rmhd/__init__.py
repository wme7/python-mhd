...
_lib.advance_U_CTU_CellCenteredB_1d.argtypes = [write_array, c_double]
_lib.advance_U_CTU_CellCenteredB_2d.argtypes = [write_array, c_double]
_lib.advance_U_CTU_CellCenteredB_3d.argtypes = [write_array, c_double]
