...
C
      ...
      SUBROUTINE RIEMANN( IT, IGAMMA, IPL, IRHOL, IVELL,
     &                                IPR, IRHOR, IVELR )
...
C     -----
      ...
      DOUBLE PRECISION IT, IGAMMA
      DOUBLE PRECISION IPL, IRHOL, IVELL
      DOUBLE PRECISION IPR, IRHOR, IVELR
...
C     -----
      ...
      DOUBLE PRECISION PMIN, PMAX, TOL, PS
...
C     ---------
      ...
      DOUBLE PRECISION A, B, C, D, E, EPS, FA, FB, FC, TOL1, 
     & XM, P, Q, R, S
